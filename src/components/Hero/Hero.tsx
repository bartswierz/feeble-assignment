...
import CallToActionBtns from "./components/CallToActionBtns";

const Hero = () => {
  return (
    <div className="max-w-[736px] w-full mx-auto flex flex-col items-center gap-8 mt-[44px]">
      <div className="flex flex-col text-center items-center gap-6 max-w-[90vw] sm:mb-12">
        ...
        <div className="max-w-[586px] w-full text-[16px] lg:text-[18px] font-normal leading-[130%]">
