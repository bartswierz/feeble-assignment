...
- I did wonder about the cloud section regarding the overall design on a desktop as the color of the background was lighter than the clouds it did make the clouds stick out a bit on the corners when zoomed out. I was thinking of changing the outer sections of the screen past the 1920px design to match the color of the cloud to make the design cleaner and give it the look that the clouds continue, however I didn't want to spend the limited time I had to complete this on that if it took away time from ensuring the other sections were pixel perfect to the final figma design.
